...
/** Groups an input with related inline or block controls. */
...
/** Positions supporting content around an input-group control. */
...
/** Renders a compact button inside an input group. */
...
/** Renders supporting text inside an input group. */
...
/** Renders the native input control inside an input group. */
